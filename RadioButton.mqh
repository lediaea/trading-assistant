...
//| Resources                                                        |
//+------------------------------------------------------------------+
#resource "Assest\\check-box-on-dark.bmp"
#resource "Assest\\check-box-off-dark.bmp"
#resource "Assest\\check-box-on-white.bmp"
#resource "Assest\\check-box-off-white.bmp"
//+------------------------------------------------------------------+
//| Class CRadioButton                                               |
...
//--- create
   if(!m_button.Create(m_chart_id,m_name+"Button",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_button.BmpNames(DARK_MODE ? "::Assest\\check-box-off-dark.bmp" : "::Assest\\check-box-off-white.bmp", DARK_MODE ? "::Assest\\check-box-on-dark.bmp" : "::Assest\\check-box-on-white.bmp"))
      return(false);
   if(!Add(m_button))
      return(false);
...
//--- create
   ...
   m_label.ColorBackground(DARK_MODE ? C'40,40,40' : C'245,245,245');
   m_label.ColorBorder(DARK_MODE ? C'40,40,40' : C'245,245,245');
   m_label.Color(DARK_MODE ? C'245,245,245' : clrBlack);
//--- succeeded
   return(true);
  }
//+------------------------------------------------------------------+
